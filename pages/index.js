...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ISITOTO | Wap Alternatif : Petualangan Tanpa Batas</title>
        ...
        <meta property="og:title" content="ISITOTO | Wap Alternatif : Petualangan Tanpa Batas" />
        ...
        <meta name="twitter:title" content="ISITOTO | Wap Alternatif : Petualangan Tanpa Batas" />
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>ISITOTO | Wap Alternatif : Petualangan Tanpa Batas</h1>
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>ISITOTO di situs resmi ISITOTO menghadirkan solusi akses digital yang inovatif dan efisien. Dibangun dengan teknologi terkini, platform ISITOTO menawarkan kecepatan loading yang superior, antarmuka minimalis yang intuitif, dan sistem keamanan mutakhir. Setiap komponen dioptimasi untuk memberikan pengalaman pengguna terbaik tanpa kompromi.</p>
            <p>Inovasi teknologi di ISITOTO melalui situs resmi ISITOTO mencakup enkripsi SSL 256-bit, arsitektur server terdistribusi dengan uptime 99,9%, dan sistem link alternatif otomatis. Platform kami mendukung semua browser dan perangkat modern, memastikan aksesibilitas universal. Tim engineering kami bekerja 24/7 untuk menjaga stabilitas dan keamanan sistem bagi seluruh pengguna.</p>
          </div>
        </div></section>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=720&h=280&fit=crop" alt="ISITOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=720&h=280&fit=crop" alt="ISITOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=720&h=280&fit=crop" alt="ISITOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
